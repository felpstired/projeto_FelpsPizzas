...
CREATE TABLE `tbcontato` (
  ...
  CONSTRAINT `FK_idcontato_idmapacontato` FOREIGN KEY (`idmapacontato`) REFERENCES `tbmapacontato` (`idmapacontato`) ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `tbcontato` (`idcontato`,`idmapacontato`,`titulo`,`conteudo`,`cadastro`,`alteracao`,`ativo`,`icone`) VALUES 
 (1,1,'Nosso Endereço','Rua Ivo de Tassis, 120 - Nova JK, Gov. Valadares - MG, 35045-570','2023-05-15 11:29:57','2023-06-29 13:01:07','A','bi-map'),
 (2,1,'Nos envie um E-mail','felpspizza@contato.com','2023-05-15 11:29:57','2023-06-29 13:01:07','A','bi-envelope'),
 (3,1,'Ligue para Nós','+55 33 9 1234-5678','2023-05-15 11:29:57','2023-06-29 13:01:07','A','bi-telephone'),
 (4,1,'Horários de Funcionamento','<strong>Seg-Sex:</strong> 11AM - 23PM;ﾠ<strong>Sáb-Dom:</strong> Fechado','2023-05-15 11:29:57','2023-06-29 13:09:14','A','bi-share');
...
INSERT INTO `tbequipe` (`idequipe`,`idfuncionarios`,`descricao`,`cadastro`,`alteracao`,`ativo`,`imagem`) VALUES 
 (4,1,'Velit aut quia fugit et et. Dolorum ea voluptate vel tempore tenetur ipsa quae aut. Ipsum exercitationem iure minima enim corporis et voluptate.','2023-05-13 17:45:23','2023-06-06 16:32:53','A','assets/img/chefs/chefs-1.jpg'),
 (5,2,'Quo esse repellendus quia id. Est eum et accusantium pariatur fugit nihil minima suscipit corporis. Voluptate sed quas reiciendis animi neque sapiente.','2023-05-13 17:45:23','2023-06-06 16:32:53','A','assets/img/chefs/chefs-2.jpg'),
 (6,3,'Vero omnis enim consequatur. Voluptas consectetur unde qui molestiae deserunt. Voluptates enim aut architecto porro aspernatur molestiae modi.','2023-05-13 17:45:23','2023-06-06 16:32:53','A','assets/img/chefs/chefs-3.jpg');
...
INSERT INTO `tbfoot` (`idfooter`,`endereco`,`telefone`,`email`,`horarios`,`cadastro`,`alteracao`,`ativo`) VALUES 
 (1,'Rua Ivo de Tassis, 120 - Nova JK<br> Gov. Valadares - MG, 35045-570<br>','+55 33 9 1234-5678','felpspizza@contato.com','<strong>Seg-Sex:</strong> 11AM - 23PM<br><strong>Sáb-Dom:</strong> Fechado','2023-05-15 11:29:57','2023-06-29 13:46:43','A');
...
INSERT INTO `tbfuncionarios` (`idfuncionarios`,`idpessoas`,`cargo`,`admissao`,`demissao`,`cadastro`,`alteracao`,`ativo`) VALUES 
 ...
 (2,6,'Confeiteira','2023-05-13 17:45:23',NULL,'2023-05-13 17:45:23','2023-06-23 14:40:25','A'),
...
INSERT INTO `tbpessoas` (`idpessoas`,`nome`,`email`,`telefone`,`cpf`,`cadastro`,`alteracao`,`ativo`) VALUES 
 ...
 (8,'anananan','aaaa@saasas.com','123123123',NULL,'2023-06-29 15:51:01','2023-06-29 15:51:01','A'),
 (9,'anananan','aaaa@saaddsas.com','123123123',NULL,'2023-06-29 15:54:49','2023-06-29 15:54:49','A'),
 (11,'Ana Luísa','analu@gmail.com','(33) 9 9923-6621',NULL,'2023-06-29 16:07:58','2023-06-29 16:07:58','A'),
 (12,'teste','asasasa@ashgajsh.com','12121212121212',NULL,'2023-06-29 16:11:54','2023-06-29 16:11:54','A');
...
CREATE TABLE `tbredessite` (
  ...
  `alteracao` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `ativo` char(1) NOT NULL DEFAULT 'A',
  PRIMARY KEY (`idredessite`,`idfooter`),
...
INSERT INTO `tbredessite` (`idredessite`,`idfooter`,`rede`,`tiporede`,`cadastro`,`alteracao`,`ativo`) VALUES 
 (1,1,'https://twitter.com/feeeelps','twitter','2023-05-15 11:29:57','2023-06-29 13:52:51','A'),
 (2,1,'https://www.facebook.com/gaming/feeeelps/','facebook','2023-05-15 11:29:57','2023-06-29 13:52:52','A'),
 (3,1,'https://www.instagram.com/felps11/','instagram','2023-05-15 11:29:57','2023-06-29 13:52:52','A'),
 (4,1,'https://br.linkedin.com/in/felps-developer-23329620b','linkedin','2023-05-15 11:29:57','2023-06-29 13:52:52','A');
...
INSERT INTO `tbreservas` (`idreservas`,`idpessoas`,`datar`,`horario`,`qtddpessoas`,`comentario`,`cadastro`,`alteracao`,`ativo`) VALUES 
 (1,11,'2023-07-12','20:20:00',2,'Nham nham pizza muito bom aiaiai','2023-06-29 16:07:58','2023-06-29 16:07:58','D'),
 (2,12,'0000-00-00','121:21:21',4,'akjdhaskdjhaskjdashdkjashjd','2023-06-29 16:11:54','2023-06-29 16:11:54','D');
...
INSERT INTO `tbsobre` (`idsobre`,`imagem`,`video`,`descricao`,`contmsg`,`contato`,`cadastro`,`alteracao`,`ativo`,`imagem2`) VALUES 
 ...
 (3,'./assets/img/testes/sobre/genshinp.png','https://www.youtube.com/watch?v=4oBpaBEMBIM','Genshin Impact é um jogo muito bom. Por favor jogue também. Por favor jogue também. Por favor jogue também. Por favor jogue também. Por favor jogue também. Por favor jogue também. Por favor jogue também. Por favor jogue também. Por favor jogue também. Por favor jogue também. Por favor jogue também. Por favor jogue também. Por favor jogue também. Por favor jogue também. Por favor jogue também. Por favor jogue também. Por favor jogue também. Por favor jogue também. Por favor jogue também. Por favor jogue também.','Jogue Agora','genshin.hoyoverse.com','2022-12-31 12:31:00','2023-06-05 19:38:32','D','./assets/img/testes/sobre/genshinv.jpg');
